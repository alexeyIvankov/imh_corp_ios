...
public class EventsCakeAssembly : AssemblyProviderImpl {
    ...
    public override func assembly() -> I_Assembly? {
        ...
        return Assembly.init(buildType:IEventsCake.self, memoryPolicy: MemoryPolicy.Strong, instanceScope: InstanceScope.Singleton, buildBlock: { (injector:I_Injector) -> AnyObject in
